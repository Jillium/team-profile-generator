        ...
        if (employees[i].employeeRole === 'Manager') {
           ...
           <div class = "card">
                <div class = "card-header">
                    ...
                    <span class="oi oi-briefcase margin-right: 4rem"></span><span>${employees[i].employeeRole}</span>
                </div>
                <div class = "card-body">
           ...
           <div class = "card-header">
               <h5>${employees[i].employeeName}</h5>
               <span class="oi oi-headphones margin-right: 4rem""></span><span>${employees[i].employeeRole}</span>
           </div>
           <div class = "card-body">
               <ul class = "list-group list-group-flush">
                   <li class = "list-group-item">ID:${employees[i].engineer.EngineerID}</li>
                   <li class = "list-group-item">Email:<a href = "mailto:${employees[i].employeeEmail}">${employees[i].employeeEmail}</a></li>
                   <li class = "list-group-item">Office Number:<a href = "http://github.com/${employees[i].engineer.engineerGithub}">${employees[i].engineer.engineerGithub}</a></li>
               </ul>
           </div>
       </div>`)
           ...
           <div class = "card-header">
               <h5>${employees[i].employeeName}</h5>
               <span class="oi oi-book margin-right: 4rem""></span><span>${employees[i].employeeRole}</span>
           </div>
           <div class = "card-body">
               <ul class = "list-group list-group-flush">
